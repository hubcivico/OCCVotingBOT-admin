(function () {
    ...
    /** @ngInject */
    function DashboardProjectController($scope, $interval, $mdSidenav, DashboardData, $window) {
        var vm = this;
        console.log("HAS PROJECT: "+$scope.$storage.user.has_project);
        if($scope.$storage.user) {
            if($scope.$storage.user.has_project == true){
                // Data
